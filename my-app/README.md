#**Objective:
Creating a memory game using React js.
![Screenshot of main page]('/src/images/Memory-Game.png').

How to play:
The user have to click on the image to add point, but should not click on the same image more than once. Once the user has got 12 points, the user wins and the scores are reset. If the user clicks on the same image twice the user loses and the score is reset to 0. 

Technologies Used:
React js.

[Github Code Link](https://github.com/atrinik11/clicky-game).

[Github Deploy Link](https://atrinik11.github.io/clicky-game/).

[Portfolio Link](https://atrinik11.github.io/updated-Portfolio/).
